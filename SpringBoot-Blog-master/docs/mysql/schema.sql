...
(
    ...
    `status`        varchar(16)      DEFAULT 'verify',
...
INSERT INTO `t_contents` (`cid`, `title`, `slug`, `created`, `modified`, `content`, `author_id`, `type`, `status`,
                          `tags`, `categories`, `hits`, `comments_num`, `allow_comment`, `allow_ping`, `allow_feed`)
VALUES (1, 'about my blog', 'about', 1487853610, 1487872488,
        '### Hello World\r\n\r\nabout me\r\n\r\n### ...\r\n\r\n...', 1, 'page', 'publish', NULL, NULL, 0, 0, 1, 1, 1),
       (2, 'Hello My Blog', NULL, 1487861184, 1487872798,
...
INSERT INTO `t_users` (`uid`, `username`, `password`, `email`, `home_url`, `screen_name`, `created`, `activated`,
                       `logged`, `group_name`)
VALUES (1, 'admin', 'a66abb5684c45962d887564f08346e8d', '362207958@qq.com', NULL, 'admin', 1490756162, 0, 0, 'visitor');
...
(
    ...
    -- 被关注人的id
    followed_id int(10) unsigned,
    primary key (user_id, followed_id),
    foreign key (user_id) references t_users (uid),
    foreign key (followed_id) references t_users (uid)
);
...
(
    ...
    user_id      int(10) unsigned,
    -- 音量大小
    auset_vol    varchar(20),
    -- 发声人
    auset_voiper varchar(20),
    -- 语速
    auset_spd    varchar(20),
    -- 音调
    auset_pit    varchar(20),
